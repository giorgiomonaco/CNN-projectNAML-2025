...
\puttitle{
	title={Convolutional Neural Networks: Theory, Architectures and Applications}, % Title of the thesis
...
\input{Chapters/1_TheoreticalandMathematicalFoundations}

\input{Chapters/2_BasicCNNArchitecture}

\input{Chapters/3_TrainingConvolutionalNeuralNetworks}

\input{Chapters/4_LandmarkandModernArchitectures}

\input{Chapters/5_PracticalApplicationsofCNNs}

\input{Chapters/6_CurrentChallengesandFutureDirections}
